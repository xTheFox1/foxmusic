...
${prefix}join ->  يدخل البوت في الروم الصوتي
${prefix}disconnect ->  يخرج البوت من الروم الصوتي
${prefix}pause ->  توقيف الاغنية مؤقتا
${prefix}resume -> تكملة الاغنية
${prefix}queue ->  اظهار قائمة التشغيل
${prefix}np ->  اظهار الاغنية الحالية
**`)
...
client.user.setGame(`فووووووووكس <3`,"http://twitch.tv/Death Shop")
